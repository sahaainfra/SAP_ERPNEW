...
const NAV: { group: string; items: { id: PageId; label: string; icon: typeof Gauge }[] }[] = [
  {
    ...
    items: [
      ...
      { id: 'gate9', label: 'Part 9 Acceptance Gate', icon: ShieldCheck },
      { id: 'gate10a', label: 'Part 10A Acceptance Gate', icon: ShieldCheck },
      { id: 'gate10b', label: 'Part 10B Acceptance Gate', icon: ShieldCheck },
      { id: 'gate10c', label: 'Part 10C Acceptance Gate', icon: ShieldCheck },
      { id: 'gate10d', label: 'Part 10D Acceptance Gate', icon: ShieldCheck },
    ],
  },
  {
...
export function Shell({ children }: { children: ReactNode }) {
  ...
  const titles: Record<PageId, [string, string]> = {
    ...
    gate10d: ['Part 10D Acceptance Gate', '24 tests — roles, approval, migration, cutover & final acceptance'],
